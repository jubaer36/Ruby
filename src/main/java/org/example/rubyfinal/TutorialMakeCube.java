        ...
        for(int sides = 0; sides<6; sides++)
        {
            for(int row=0; row<3; row++)
            {
                for(int col=0; col<3; col++)
                {
                    ...
                    buttonStates[sides][row][col] = Tutorial.tutorialCubeState[sides][row][col];
...
//        colorCube();
        ...
        for(int sides = 0; sides<6; sides++)
        {
            for(int row=0; row<3; row++)
            {
                for(int col=0; col<3; col++)
                {
                    ...
                    }else if(buttonStates[sides][row][col] == 5){
                        button.setStyle("-fx-background-color: rgb(255, 221, 0);");  //yellow

                    }
                    else button.setStyle("-fx-background-color: rgb(128,128,128);");  //gray
    ...
    public void polycolor(Polygon thepoly, int sides, int row, int col)
    {
        ...
        else thepoly.setFill(Color.rgb(128, 128, 128)); // gray
    }
    ...
    public void pressButtonRotateU()
    {
        ...
        TutorialRotateCube.rotateU_Dash();
        colorCube();
    }
    ...
    public void pressButtonRotateD()
    {
        ...
        TutorialRotateCube.rotateD();
        colorCube();
    }

    public void pressButtonRotateD_Dash()
    {
        TutorialRotateCube.rotateD_Dash();
        colorCube();
    }

    public void pressButtonRotateR_Dash()
    {
        TutorialRotateCube.rotateR();
        colorCube();
    }

    public void pressButtonRotateR()
    {
        TutorialRotateCube.rotateR_Dash();
        colorCube();
    }

    public void pressButtonRotateL()
    {
        TutorialRotateCube.rotateL();
        colorCube();
    }

    public void pressButtonRotateL_Dash()
    {
        TutorialRotateCube.rotateL_Dash();
        colorCube();
    }

    public void pressRotateX_Axis()
    {
        TutorialRotateCube.rotateX_Axis();
        colorCube();
    }
    public void pressRotateX_Axis_Dash()
    {
        TutorialRotateCube.rotateX_Axis_Dash();
        colorCube();
    }

    public void pressRotateY_Axis_Dash()
    {
        TutorialRotateCube.rotateY_Axis_Dash();
        colorCube();
    }

    public void pressRotateY_Axis()
    {
        TutorialRotateCube.rotateY_Axis();
        colorCube();
    }

    public void pressRotateF()
    {
        TutorialRotateCube.rotateF();
        colorCube();
    }

    public void pressRotateF_Dash()
    {
        TutorialRotateCube.rotateF_Dash();
        colorCube();
    }

    public void pressRotateB_Dash()
    {
        TutorialRotateCube.rotateB();
        colorCube();
    }

    public void pressRotateB()
    {
        TutorialRotateCube.rotateB_Dash();
        colorCube();
    }
